...
| Four stems | Chinese four-file import, missing files, EQ enable/edit, live preview, Bounce/download, source invalidation | Cloud Demucs not exercised |
...
Final command results are recorded in [the checkpoint](AUDIO_TRUST_CHECKPOINT_2026-09-20.md). Firefox/WebKit, long sessions, external devices, cloud credentials, saved projects and true vocal reference datasets are NOT RUN / not implemented; this matrix is not full DAW acceptance.
